...
var Map = (function() {
	...
	function MapInitialisation(obj, iterable) {
		...
		// 6. Set objâ€™s [[MapData]] internal property to a new empty List.
	...
	defineValuesWC(Map.prototype, {
		...
		clear: function clear() {
			...
			// 4. Set the value of Mâ€™s [[MapData]] internal property to a new empty List.
			S.set('[[MapData]]', create(null));
			S.set('Map:size', 0);
			S.set('#MapRecordId', 'Map:id:' + (mNumber++));
			S.set('Map:primitive-keys', create(null));
		...
		delete: function delete_(key) {
			...
			// 4. Let entries be the List that is the value of Mâ€™s [[MapData]] internal property.
		...
		forEach: function forEach(callbackfn/*, thisArg = undefined */) {
			...
			// 6. Let entries be the List that is the value of Mâ€™s [[MapData]] internal property.
			var entries = S.get('[[MapData]]');
...
(function() {
	...
	shimProps(Math, {
		...
		log1p: function(x) {
			...
			// If x is +0, the result is âˆ’Infinity.
			// If x is âˆ’0, the result is âˆ’Infinity.
...
var Set = (function() {
	...
	function SetInitialisation(obj, iterable) {
		...
		// 8. Set objâ€™s [[SetData]] internal property to a new empty List.
	...
	defineValuesWC(Set.prototype, {
		...
		add: function add(value) {
			...
			// 4. Let entries be the List that is the value of Sâ€™s [[SetData]] internal property.
		...
		clear: function clear() {
			...
			// 4. Set the value of Sâ€™s [[SetData]] internal property to a new empty List.
			$.set('[[SetData]]', new Map());
		...
		forEach: function forEach(callbackfn/*, thisArg */) {
			...
			// 6. Let entries be the List that is the value of Sâ€™s [[SetData]] internal property.
			var entries = $.get('[[SetData]]');
...
(function() {
	...
	shimProps(String.prototype, {
		...
		repeat: function repeat(count) {
			...
			// 6. If n â‰¤ 0, then throw a RangeError exception.
...
var WeakMap = (function() {
	...
	function WeakMapInitialisation(obj, iterable) {
		...
		// 6. Set objâ€™s [[WeakMapData]] internal property to a new empty List.
	...
	defineValuesWC(WeakMap.prototype, {
		...
		clear: function clear() {
			...
			// 4. Set the value of Mâ€™s [[WeakMapData]] internal property to a new empty List.
			S.set('[[WeakMapData]]', create(null));
			S.set('#weakMapRecordId', 'WeakMap:id:' + (wmNumber++));
		...
		delete: function delete_(key) {
			...
			// 4. Let entries be the List that is the value of Mâ€™s [[WeakMapData]] internal property.
